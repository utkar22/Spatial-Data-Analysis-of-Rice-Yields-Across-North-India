...
plot(yield.vgm,
     ...
     type="b",
     main = "Variogram for non-detrended yield data (Middle Indo-Gangetic Plain)"
)
...
plot(yield.vgm.detrend.x,
     ...
     ylab="Gamma(h), Semivariance",
     type="b",
     main = "Variogram for yield data detrended on longitude (Middle Indo-Gangetic Plain)"
)
...
plot(yield.vgm.detrend.y,
     ...
     ylab="Gamma(h), Semivariance",
     type="b",
     main = "Variogram for yield data detrended on latitude (Middle Indo-Gangetic Plain)"
)
...
plot(yield.vgm.detrend.xy,
     ...
     ylab="Gamma(h), Semivariance",
     type="b",
     main = "Variogram for yield data detrended on both latitude and longitude (Middle Indo-Gangetic Plain)"
)
...
plot(yield.vgm.detrend.full,
     ...
     ylab="Gamma(h), Semivariance",
     type="b",
     main = "Variogram for yield data detrended on all explanatory variables (Middle Indo-Gangetic Plain)"
)
...
plotly::plot_ly(type="scatter", mode="lines+markers") %>%
  ...
  layout(title = "Variograms for Middle Indo-Gangetic Plain",
