...
plot(yield.vgm,
     ...
     type="b",
     main = "Variogram for non-detrended yield data (Trans Gangetic Plain)"
)
...
plot(yield.vgm.detrend.x,
     ...
     ylab="Gamma(h), Semivariance",
     type="b",
     main = "Variogram for yield data detrended on longitude (Trans Gangetic Plain)"
)
...
plot(yield.vgm.detrend.y,
     ...
     ylab="Gamma(h), Semivariance",
     type="b",
     main = "Variogram for yield data detrended on latitude (Trans Gangetic Plain)"
)
...
plot(yield.vgm.detrend.xy,
     ...
     ylab="Gamma(h), Semivariance",
     type="b",
     main = "Variogram for yield data detrended on both latitude and longitude (Trans Gangetic Plain)"
)
...
plot(yield.vgm.detrend.full,
     ...
     ylab="Gamma(h), Semivariance",
     type="b",
     main = "Variogram for yield data detrended on all explanatory variables (Trans Gangetic Plain)"
)
